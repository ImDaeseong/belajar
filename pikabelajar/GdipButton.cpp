...
BOOL CGdipButton::LoadStdImage(LPCTSTR pName)
{
	m_pStdImage = new CGdiPlusBitmapResource;
	return m_pStdImage->Load(pName);
}

BOOL CGdipButton::LoadStdImage(UINT id, LPCTSTR pType, HMODULE hInst, int nStartX, int nStartY)
{
	m_nStartX = nStartX;
	m_nStartY = nStartY;
...
BOOL CGdipButton::LoadAltImage(UINT id, LPCTSTR pType, HMODULE hInst, int nStartX, int nStartY)
{
	m_bHaveAltImage = TRUE;
	m_pAltImage = new CGdiPlusBitmapResource;
...
void CGdipButton::OnDrawWindow(Graphics &Gps)
{
...
void CGdipButton::SetImagePos(int nStartX, int nStartY)
{
	m_nStartX = nStartX;
	m_nStartY = nStartY;	
}

LRESULT CGdipButton::WindowProc(UINT nMessage, WPARAM wParam, LPARAM lParam)
{
...
void CGdipButton::SetOneButton(BOOL bOneButton)
{
